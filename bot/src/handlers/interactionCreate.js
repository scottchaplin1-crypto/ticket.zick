...
import { handleBalance, handleStore, handleBuy, handleBuyAutocomplete, handleGiveCurrency, handleWork } from "../commands/economy.js";
    ...
    try {
      if (interaction.isChatInputCommand()) {
        switch (interaction.commandName) {
          ...
          case "work": return handleWork(interaction);
