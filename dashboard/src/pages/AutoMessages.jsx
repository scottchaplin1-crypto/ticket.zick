...
export default function AutoMessages({ guildId }) {
  return (
    <PremiumGate guildId={guildId} feature="Auto Messages">
      <AutoMessagesContent guildId={guildId} />
    </PremiumGate>
  );
}

function AutoMessagesContent({ guildId }) {
        ...
        <div className="sticky top-6">
          <Card title="Live preview">
            <div className="bg-[#313338] rounded-lg p-4 space-y-3">
              {form.content && <p className="text-gray-100 text-sm whitespace-pre-wrap">{renderRichText(form.content)}</p>}
