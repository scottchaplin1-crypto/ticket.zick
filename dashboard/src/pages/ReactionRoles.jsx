...
import { Plus, Trash2, Send, CheckCircle2, Smile } from "lucide-react";
          ...
          <Card title="Configuration">
            <div className="space-y-3">
              <label className="block">
                <span className="block text-xs text-gray-400 mb-1">Panel name (internal)</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <label className="block">
                  <span className="block text-xs text-gray-400 mb-1">Mode</span>
            ...
            <div className="space-y-2">
              {form.mappings.map((m, i) => (
                <div key={i} className="flex items-center gap-2 bg-surface3 rounded-lg p-2">
                  ...
                  <select className="input h-10 flex-1" value={m.roleId} onChange={(e) => updateMapping(i, "roleId", e.target.value)}>
