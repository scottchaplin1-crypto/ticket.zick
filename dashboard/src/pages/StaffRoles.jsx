    ...
    <div>
      ...
      <Card>
        <div className="flex gap-2 mb-4">
          ...
          <button onClick={add} disabled={!selectedRoleId} className="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-[#0b1416] shadow-md shadow-cyan-500/20 transition rounded-lg text-sm font-medium whitespace-nowrap disabled:opacity-50">
            Add
          </button>
        </div>
