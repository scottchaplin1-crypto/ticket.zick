      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8 max-w-5xl">
          <Routes>
            ...
            <Route path="auto-messages" element={<AutoMessages guildId={guildId} />} />
            <Route path="economy" element={<Economy guildId={guildId} />} />
            <Route path="giveaways" element={<Giveaways guildId={guildId} />} />
            <Route path="polls" element={<Polls guildId={guildId} />} />
            <Route path="billing" element={<Billing guildId={guildId} />} />
            <Route path="osrs-sync" element={<OsrsSync guildId={guildId} />} />
            <Route path="moderation" element={<Moderation guildId={guildId} />} />
          </Routes>
        </div>
      </div>
    </UnsavedChangesProvider>
