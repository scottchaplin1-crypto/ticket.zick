...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-7 px-4">
      ...
      <a
        href={authorizeUrl}
        className="px-6 py-3 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-[#0b1416] shadow-md shadow-cyan-500/20 transition font-semibold shadow-lg shadow-cyan-500/20"
      >
