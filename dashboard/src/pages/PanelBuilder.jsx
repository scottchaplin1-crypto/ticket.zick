...
import { Plus, Ticket, Trash2, Palette, MousePointerClick, Settings2, FileText, Info, AtSign } from "lucide-react";
...
export default function PanelBuilder({ guildId }) {
  ...
  function toPayload() {
    return { ...form, pingRoleIds: JSON.stringify(form.pingRoleIds) };
  }
