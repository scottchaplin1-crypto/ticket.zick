...
import { renderRichText } from "../utils/renderRichText.jsx";
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-5">
        Build the button members click to open a ticket, and everything that happens once they do.
      </p>
      ...
      {!loaded ? (
        ...
        <div className="grid grid-cols-2 gap-6 items-start">
          <div>
            <Tabs
              tabs={[
                    ...
                    <div className="space-y-4">
                      <Card>
                        ...
                        <div className="space-y-3">
                          ...
                          <Field
                            label="Embed title"
                            hint="The bold headline shown at the top of the panel message in Discord."
                            actions={<EmojiPicker guildId={guildId} mode="insert" onInsert={(code) => setForm({ ...form, embedTitle: form.embedTitle + code })} />}
                          >
                            <input className="input" value={form.embedTitle} onChange={set("embedTitle")} />
                          </Field>
                          <Field
                            label="Embed description"
                            actions={<EmojiPicker guildId={guildId} mode="insert" onInsert={(code) => setForm({ ...form, embedDescription: form.embedDescription + code })} />}
                          >
                      ...
                      <Card>
                        ...
                        <div className="space-y-3">
                          ...
                          <Field
                            ...
                            actions={<EmojiPicker guildId={guildId} mode="insert" onInsert={(code) => setForm({ ...form, welcomeMessage: form.welcomeMessage + code })} />}
                          >
                ...
                },
                {
                  ...
                  content: (
                    <Card>
                      <SectionHeading icon={UserCog} title="Roles on ticket actions" />
            ...
            {/* Save/Delete stay outside the tabs — reachable no matter which one you're on */}
          ...
          <div className="sticky top-6">
            <Card title="Live preview">
              <div className="bg-[#313338] rounded-lg p-4 border-l-4" style={{ borderColor: form.embedColor }}>
                <p className="font-bold text-white">{renderRichText(form.embedTitle)}</p>
                <p className="text-gray-300 text-sm mt-1 whitespace-pre-wrap">{renderRichText(form.embedDescription)}</p>
            ...
            <Card title="When the ticket opens…" actions={<span className="text-xs text-gray-500">What's shown inside</span>}>
              <div className="bg-[#313338] rounded-lg p-4 border-l-4" style={{ borderColor: form.embedColor }}>
                ...
                <p className="text-gray-300 text-sm mt-1 whitespace-pre-wrap">{renderRichText(form.welcomeMessage)}</p>
                <p className="text-gray-500 text-xs mt-2">{renderRichText(form.footerText)}</p>
              </div>
            </Card>
          </div>
        </div>
...
function Field({ label, hint, actions, children }) {
  return (
    <label className="block">
      <span className="flex items-center justify-between gap-1.5 text-xs text-gray-400 mb-1">
