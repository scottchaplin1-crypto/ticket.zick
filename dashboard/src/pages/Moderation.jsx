...
export default function Moderation({ guildId }) {
  ...
  useEffect(() => {
    api.get(`/api/moderation/guild/${guildId}`).then((res) => setForm(res.data));
  ...
  const status = useAutoSave(form, () => api.put(`/api/moderation/guild/${guildId}`, form), {
    enabled: !!form,
    resetKey: guildId,
  });
            ...
            <div className="space-y-3">
              <label className="block">
                ...
                <Select
                  ...
                  onChange={(v) => setForm({ ...form, modLogChannelId: v })}
              ...
              <Toggle
                ...
                onChange={(v) => setForm({ ...form, autoBanEnabled: v })}
                ...
                <>
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) => setForm({ ...form, autoBanMinAgeDays: e.target.value })}
                    />
                  </label>
