    ...
    <div>
      ...
      <div className="mb-2">
        ...
        <Select
          ...
          options={items.map((i) => ({ value: i.id, label: `${i.emoji} ${i.name} — ${i.price}` }))}
            ...
            <div className="divide-y divide-white/5 max-h-64 overflow-y-auto">
              {balances.map((b) => (
                <div key={b.id} className="py-2 flex items-center justify-between text-sm">
                  ...
                  <span className="text-gray-400">{b.balance}</span>
                </div>
              ))}
            ...
            <div className="divide-y divide-white/5 max-h-64 overflow-y-auto">
              {purchases.map((p) => (
                <div key={p.id} className="py-2 text-sm">
                  <p className="text-gray-300">{p.itemName} <span className="text-gray-500">— {p.price}</span></p>
