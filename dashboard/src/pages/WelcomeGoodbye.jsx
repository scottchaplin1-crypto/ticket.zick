  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <Card>
          <Toggle
            checked={form.stickerButtonEnabled}
            onChange={(v) => update({ stickerButtonEnabled: v })}
            label="Show a 'Send a welcome sticker' button under the welcome message"
          />
          <p className="text-xs text-gray-500 mt-2">
            Any member (not just the joiner) can click it to post a random real sticker from this server's own
            sticker pack — a fun, low-effort way for the community to say hi. Needs your server to actually have
            custom stickers uploaded (Server Settings → Emoji &amp; Stickers) — the button will say so if there
            aren't any yet.
          </p>
        </Card>
      </div>
