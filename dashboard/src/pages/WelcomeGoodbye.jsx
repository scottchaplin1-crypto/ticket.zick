    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-2 text-sm text-gray-300">
              <input type="checkbox" checked={form.welcomeEnabled} onChange={set("welcomeEnabled")} />
              Post a message when someone joins
            </label>
            {form.welcomeEnabled && (
              <>
        ...
        <Card>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-2 text-sm text-gray-300">
              <input type="checkbox" checked={form.goodbyeEnabled} onChange={set("goodbyeEnabled")} />
