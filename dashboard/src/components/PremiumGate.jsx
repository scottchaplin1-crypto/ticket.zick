...
export default function PremiumGate({ guildId, feature, children }) {
  ...
  useEffect(() => {
    api
      ...
      .catch(() => setStatus({ subscribed: true })); // fail open — a network hiccup here shouldn't trap someone on an infinite loading screen; the server routes are the real gate regardless
  }, [guildId]);
