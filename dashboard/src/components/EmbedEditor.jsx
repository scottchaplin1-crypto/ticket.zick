            ...
            <label className="block">
              <span className="flex items-center justify-between text-xs text-gray-400 mb-1">
                <span className="flex items-center gap-1.5">
                  Title
                  <Tooltip text="Bold/italic/links here work correctly once posted in Discord — but this dashboard's preview shows plain text, so formatting won't visually appear below until you actually send it.">
