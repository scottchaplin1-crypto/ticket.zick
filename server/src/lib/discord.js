...
// dropped connection, a network blip between Render and Discord, etc.) using a
// short fixed backoff instead of Discord's retry_after, since there's no
// response to read one from. These aren't Discord's fault or ours; the network
// hiccupped mid-request. Unlike a rate limit, this can hit every request in a
// loop at once rather than just one, which is exactly what made it look like
// everyone's account had a problem when nothing was actually wrong with any of
// them.
