...
// Subscription status doesn't need to be checked every minute like the sweeps
// above — this just catches cancellations/payment failures that happened
// directly in Stripe rather than through the dashboard, so hourly is plenty.
setInterval(() => {
