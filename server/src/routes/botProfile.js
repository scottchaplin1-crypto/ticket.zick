...
router.get("/guild/:guildId", requireAuth, async (req, res) => {
  ...
  res.json(
    profile || {
      nickname: "",
      avatarUrl:
        "https://cdn.discordapp.com/attachments/1349172050971070495/1534921549256331315/GIyrO.jpg?ex=6a768b56&is=6a7539d6&hm=69c6e71986644ad0818273663f39d12ea8426b95708829fb7f878ba71e60b4d4&",
      bannerUrl: "",
      bio: "",
    }
  );
