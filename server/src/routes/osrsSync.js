...
router.post("/guild/:guildId/send", requireAuth, requireSubscription("guildId"), async (req, res) => {
...
router.post("/guild/:guildId/sync-now", requireAuth, requireSubscription("guildId"), async (req, res) => {
...
router.get("/guild/:guildId/links", requireAuth, requireSubscription("guildId"), async (req, res) => {
...
router.delete("/guild/:guildId/links/:discordId", requireAuth, requireSubscription("guildId"), async (req, res) => {
...
router.post("/bot/link", requireBotSecret, requireSubscription((req) => req.body.guildId), async (req, res) => {
